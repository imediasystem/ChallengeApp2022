namespace ChallengeApp2022.Tests
{
    public class EmployeeTests
    {
        ...
        {
            var employee1 = new EmployeeInMemory("Zenon", "Kalicki", 'M', 32);
        ...
        {
            var employee2 = new EmployeeInMemory("Karol", "Mazur", 'M', 34);
        ...
        {
            var employee3 = new EmployeeInMemory("Jakub", "Kowalski", 'M', 27);
